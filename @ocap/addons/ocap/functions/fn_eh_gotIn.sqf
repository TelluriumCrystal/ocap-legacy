...
if (ocap_enableCapture and _unit getVariable ["ocap_isInitialised", false] and _vehicle getVariable ["ocap_isInitialised", false]
	...
	if (ocap_debug) then {
		...
		systemChat format["OCAP: [%1] %2 (%3) got in %4 (%5)", _timestamp, name _unit, _unitId, _vehicleName, _vehicleId];
		diag_log format["OCAP: [%1] %2 (%3) got in %4 (%5)", _timestamp, name _unit, _unitId, _vehicleName, _vehicleId];
	};
};
