/*
	Function: ocap_fnc_eh_gotOut

	Description:
	Mission event handler for "GetOut". Builds a capture string for an entity exiting a vehicle
...
if (ocap_enableCapture and _unit getVariable ["ocap_isInitialised", false] and _vehicle getVariable ["ocap_isInitialised", false]
	...
	private _captureString = format ["5;%1;%2;%3;0", _timestamp, _unitId, _vehicleId];
